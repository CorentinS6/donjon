...
use ndj\DGameBundle\Entity\Banque;
use ndj\DAdminBundle\Form\BanqueType;
...
class BanqueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ndjDGameBundle:Banque')->findAll();
     ...
     *
     * @Route("/", name="banque_create")
     * @Method("POST")
     * @Template("ndjDAdminBundle:Banque:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ndjDGameBundle:Banque')->find($id);
     ...
     *
     * @Route("/{id}", name="banque_update")
     * @Method("PUT")
     * @Template("ndjDAdminBundle:Banque:edit.html.twig")
     */
