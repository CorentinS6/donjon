...
use ndj\DAdminBundle\Form\OrganisationType;
...
class OrganisationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ndjDGameBundle:Organisation')->findAll();
     ...
     * @Method("POST")
     * @Template("ndjDAdminBundle:Organisation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ndjDGameBundle:Organisation')->find($id);
     ...
     * @Method("PUT")
     * @Template("ndjDAdminBundle:Organisation:edit.html.twig")
     */
